<h1 align="center">🚀 Asteroids: A Python Pygame Arcade Classic</h1>

<p align="center">
  <img src="https://img.shields.io/badge/Pygame-2.0-brightgreen.svg" />
  <img src="https://img.shields.io/github/languages/top/divyanshsirohi/asteroids-game?color=yellow" />
...
├── asteroidfield.py    # Manages the asteroid swarm
├── shot.py             # Bullet/projectile logic
├── circleshape.py      # Base shape handling (collision, drawing)
